...
5. Cài đặt 5 skill bên ngoài (React Router, Vitest, React Best Practices, Composition Patterns, Web Design Guidelines)
...
- **Trạng thái pipeline**: Quét tất cả tính năng và báo cáo trạng thái hiện tại với hướng dẫn bước tiếp theo:
  ...
  - `fixing` → đề xuất `fe-review` (hoặc `fe-gen` nếu cần sinh lại)
