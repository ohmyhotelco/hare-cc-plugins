...
model: opus
tools: Read, Write, Edit, Glob, mcp__plugin_planning-plugin_notion__notion-fetch, mcp__plugin_planning-plugin_notion__notion-search, mcp__plugin_planning-plugin_notion__notion-create-pages, mcp__plugin_planning-plugin_notion__notion-update-page
---
...
- If `existingPages` contains `parentPageUrl`: use `mcp__plugin_planning-plugin_notion__notion-update-page` with that URL
- If `existingPages` contains only legacy `pageUrl`: treat it as the parent page URL, update it
- Otherwise: use `mcp__plugin_planning-plugin_notion__notion-create-pages` to create a new page
...
For each child page:
- If `existingPages.childPages.{key}` exists: use `mcp__plugin_planning-plugin_notion__notion-update-page`
- Otherwise: use `mcp__plugin_planning-plugin_notion__notion-create-pages` with the parent page as parent
