<!-- Synced with en version: 2026-03-05T12:00:00Z -->
...
2. **Stage 2 — 프로토타입 생성**: Prototype Generator 에이전트가 UI DSL을 읽고, `src/prototypes/{feature}/`에 독립형 Vite + React 19 + TypeScript + TailwindCSS + shadcn/ui + React Router v7 + Lucide 프로젝트를 생성한 후, 단일 독립형 `bundle.html`로 번들링합니다
