...
2. **Stage 2 — Tạo Prototype**: Tác tử Prototype Generator đọc UI DSL và tạo dự án Vite + React 19 + TypeScript + TailwindCSS + shadcn/ui + React Router v7 + Lucide độc lập trong `src/prototypes/{feature}/`, sau đó đóng gói thành một tệp `bundle.html` độc lập duy nhất
