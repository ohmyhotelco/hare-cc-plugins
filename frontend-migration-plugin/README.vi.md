...
> Trạng thái: tooling đã hoàn chỉnh (v0.11.0). Plugin **không** chứa các app sản phẩm — nó vận hành
...
/frontend-migration-plugin:fm-style-spec hotel-booking-info   # → style-spec.json (giá trị computed legacy trực tiếp + assets + cấu trúc)
