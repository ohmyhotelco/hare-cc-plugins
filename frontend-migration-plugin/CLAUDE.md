...
> Status: **feature-complete tooling (v0.5.0)** — all `fm-*` skills, agents, and templates are
...
All skills are implemented (v0.5.0). The "Built in" column records the task that delivered each
